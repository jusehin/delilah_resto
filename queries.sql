...
CREATE TABLE `delilah_resto`.`products` ( `id` INT NOT NULL AUTO_INCREMENT , `item` VARCHAR(100) NOT NULL , `photo` VARCHAR(255) NULL DEFAULT 'https://www.maestromanolo.es/wp-content/themes/456repair/assets//img/no-product-image.png' , `description` TEXT NOT NULL , `price` INT NOT NULL , `is_deleted` BOOLEAN NOT NULL DEFAULT FALSE, PRIMARY KEY (`id`)) ENGINE = InnoDB;
